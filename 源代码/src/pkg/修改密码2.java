			...
			public void actionPerformed(ActionEvent arg0) {
				 ...
				 String driverName="com.microsoft.sqlserver.jdbc.SQLServerDriver";
				  ...
				  try
				  {
				   ...
				   String sql1 = "select count(*) from tb_yonghu where pw='"+jma.getText()+"'";//这里也可以写成select *,不同的方法				
                 ...
                 String str=jma.getText();
				   ...
				   if(xma.getText().equals(csxma.getText())) {
					   String sql="update tb_yonghu set pw='"+xma.getText()+"'  where un='"+username.getText()+"' ";//生成一条sql语句
